...
/** @param {import("..").NS } ns */
export async function handleAttackServer(
  ns,
  showWindow = false,
  width = 500,
  height = 180,
...
async function printServerDetails(ns, host, securityThresh, numTimesToHack, hackType, numHackers) {
  ...
  if (hackType == ACTIONS.HACK) {
    ...
    ns.print(
      'Incorrect hackType in getServerDetails. Only hack, grow, and weaken are allowed. Ending script.'
    );
    return;
  }
